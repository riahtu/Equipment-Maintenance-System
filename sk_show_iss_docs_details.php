...
//session_start();
 ...
 require('db_ems.php');
	...
	if (!mysql_num_rows($result1) == 0 )
	{
		...
		echo "<tr><td style='width:150px;height:30px;'>Issue Document No </td><td class='show_picking_doc' recno='$recno' style='font-size:20px;color:#D96C00;cursor:pointer;'>$_GET[docno]</td><td style=''></td><td></td></tr>";
		...
		echo "<tr><td>Requisition No</td><td style='' colspan=4>$workorderid </td></tr>";
		...
		*/
		...
		while($row1 = mysql_fetch_array($result1))
		{
			...
			echo "<td class='s_sparepartid' style='text-align:center;border-bottom:1px solid #D8D8D8;' > $row1[sparepartid]  </td>";
			echo "<td class='s_sparepartid' style='text-align:center;border-bottom:1px solid #D8D8D8;' > $row1[part_number]  </td>";
			echo "<td class='s_barcode' style='text-align:center;border-bottom:1px solid #D8D8D8;' > $row1[barcode]  </td>";
			echo "<td style='text-align:left;padding-left:3px;border-bottom:1px solid #D8D8D8;' > $row1[sp_description]  </td>";
			echo "<td class='s_orderqty' style='text-align:center;border-bottom:1px solid #D8D8D8;' > $qty  </td>";
			echo "</tr> ";
