<?php
 ...
 require('db_ems.php');
 $docno = $_GET[docno];
$result1 = mysql_query("SELECT * from mprv_reverse_header where docno = '$_GET[docno]' and status = 'C'");
...
echo "<div style='text-align:left;margin-top:20px;color:#007CB9;font-weight:bold;'>Purchase Order Return Details</div>";
