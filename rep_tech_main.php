...
echo "<tr>";// left menu
echo "<td style='width:300px;'>Reports - Technician</td>";
...
echo "<tr><td program='rep_t1.php' class='rep_left_menu rep_left_menu_pick' style=''>Requisitions</td></tr>";
echo "<tr><td program='rep_t2.php' class='rep_left_menu' style=''>Maintenance</td></tr>";
echo "<tr><td program='rep_t3.php' class='rep_left_menu' style=''>Stock Balance</td></tr>";
echo "</table>";
