...
echo "<tr>";// left menu
echo "<td style='width:300px;'>Physical Count</td>";
...
echo "<tr><td id='pc_m1' class='pp_left_menu pp_left_menu_pick' program='pc_m1.php' style=''>Generate New PC Schedule</td></tr>";

echo "<tr><td id='pc_m2' class='pp_left_menu' program='pc_m2.php' style=''>PC Schedule Listings</td></tr>";
echo "</table>";
