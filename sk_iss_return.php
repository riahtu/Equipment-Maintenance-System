...
session_start();
 require('db_ems.php');
echo "<div style='text-align:left;width:80%;font-size:20px;text-align:left;font-weight:bold;color:#404000;'>Issue Parts Return</div>";
echo "<p id='changeList' class='changeList' program='sk_iss_return2.php'>Change List Style</p>";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		echo "<div id='pick_iss_docsx' class='icon_part_change' title='View' docno='$row1[docno]'></div>";
