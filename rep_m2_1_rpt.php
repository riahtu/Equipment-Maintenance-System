...
echo "<tr><td style='font-weight:bold;'>Report : Machine Listing</td></tr>";
echo "<tr><td style=''>Date : $now</td>";
echo "</table>";

echo "<table align='center' style='margin-top:20px;font-size:10px;font-family:arial;margin-bottom:30px;text-align:left;border-collapse:collapse;border:1px solid black;border-bottom:1px solid #E9E9E9; >";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		{	
			...
			echo "<td style='width:103px;font-weight:bold;text-align:center;border-bottom:1px solid black;padding-left:3px;vertical-align:top;padding-top:3px;'>Required Quantity</td></tr>";
