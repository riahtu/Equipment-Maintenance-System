...
echo "<tr>";// left menu
echo "<td style='width:300px;'>My Store Transactions</td>";
...
echo "<tr><td id='sk_open_wo' class='mm_left_menu mm_pick' style=''>Open Requisitions</td></tr>";
echo "<tr><td id='sk_closed_wo' class='mm_left_menu' style=''>Closed Requisitions</td></tr>";
echo "<tr><td id='sk_iss_docs' class='mm_left_menu' style=''>Issue Parts Documents</td></tr>";
echo "<tr><td id='sk_iss_return' class='mm_left_menu' style=''>Issue Parts Return</td></tr>";
echo "</table>";
echo "</td><td>";
