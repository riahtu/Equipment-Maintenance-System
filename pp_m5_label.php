<?php
echo "<div style='text-align:left;width:500px;font-size:20px;text-align:left;font-weight:bold;color:#404000;'>&nbsp;Print Spare Parts Stock Label</div>";
...
echo "<tr>";
echo "<td><button id='part_change_cancel'  style='width:100px;height:30px;'>Cancel</button>";
...
?>
<script>
	var program = 'pp_m5_label_list.php';
