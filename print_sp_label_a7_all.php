...
while($row1 = mysql_fetch_array($result1))
{
	...
	$qrlot = $sparepartid.'-'.$maker.'-'.$barcode;//$sparepartid;// .'-'.$maker.'-'.$barcode;
	...
	<table border="0"  width="100%" >	
	<tr><td style="font-weight:bold;color:#000000;font-size:7px;">Label No :&nbsp;'.$qrlot.' printed on '.$nowfull.' by '.$row1[userid].'.</td></tr>
	</table>';
