...
session_start();
 date_default_timezone_set('Asia/Kuala_lumpur');
   ...
   $cyear = date("Y");
 require('db_ems.php');
echo "<div style='margin-top:20px;text-align:left;color:#007CB9;font-weight:bold;'>Selections : Sparepart Listing </div>";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	*/	echo "</td></tr>";
		...
		echo "<td><button id='rep_m1_1_execute' program='rep_m1_1_rpt.php' sparepartid='$_GET[sparepartid]' style='width:100px;height:30px;'>Execute</button></tr>";
		echo "</table>";
