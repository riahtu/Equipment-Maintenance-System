...
$result1= mysql_query("SELECT * from m_bingroup order by recno ");
...
echo "<div style='margin-top:10px;margin-left:10px;width:1000px; padding:10px;background-color:#6F6F35;'>";
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		if ($nn > 15 ) {  echo "</tr><tr><td style='height:10px;'></td></tr><tr class='' >"; $nn = 0;}
		echo "<td class='box_loc' bingroup='$row1[bingroup]' style=''>$row1[bingroup] </td>";
