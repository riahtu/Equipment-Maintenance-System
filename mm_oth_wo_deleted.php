...
require("db_ems.php");
echo "<table>";
echo "<tr><td style='width:900px;text-align:left;height:30px;'>Others : List of deleted Requisition </td><td> </td></tr>";
echo "</table>";
...
echo "<td style='width:200px;height:30px;font-weight:bold;border:1px solid #ACACAC;padding-left:3px;'>Closed by</td>";
...
{
		echo "<tr >";
		echo "<td  style='text-align:center;border:0px;width:1028px;font-size:14px;color:#FF0000;height:30px;' colspan=9>No Record found</td>";
		echo "</tr>";
