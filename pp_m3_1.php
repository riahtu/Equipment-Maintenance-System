...
$result1 = mysql_query("SELECT * from mpr_receipt_header where  status = 'P' order by docno desc ");
if (!mysql_num_rows($result1) == 0 )
{
	while($row1 = mysql_fetch_array($result1))
    {
		...
		echo "<div class='pp_m3_1_choose' docno='$row1[docno]' style='cursor:pointer;border:1px solid #63B1B1;width:250px;min-height:100px;border-radius:5px;display: inline-block;margin:20px;'>";
