...
require("db_ems.php");
echo "<table>";
echo "<tr><td style='width:900px;text-align:left;height:30px;'>Others : List of closed Requisition </td><td> </td></tr>";
echo "</table>";
...
{
		echo "<tr >";
		echo "<td  style='text-align:center;border:0px;width:1028px;font-size:14px;color:#FF0000;height:30px;' colspan=6>No Record found</td>";
		echo "</tr>";
