...
echo "<tr>";// left menu
echo "<td style='width:300px;'>Parts Purchase</td>";
...
echo "<tr><td id='pp_m1' class='pp_left_menu pp_left_menu_pick' program='pp_m1.php' style=''>Purchase Receive</td></tr>";
echo "<tr><td id='pp_m2' class='pp_left_menu' program='pp_m2.php' style=''>Purchase Order Return</td></tr>";
echo "<tr><td id='pp_m3' class='pp_left_menu' program='pp_m3.php' style=''>Purchase Parts Return</td></tr>";
echo "<tr><td id='pp_m4' class='pp_left_menu' program='pp_m4.php' style=''>Purchase History</td></tr>";
//echo "<tr><td id='pp_m5' class='pp_left_menu' program='pp_m5.php' style=''>Print Sparepart Label</td></tr>";
