...
session_start();
 date_default_timezone_set('Asia/Kuala_lumpur');
   ...
   $today = date("Y-m-d");
    $cyear = date("Y");
 require('db_ems.php');
echo "<p id='changeList_pp' class='changeList' program='pp_m3_2.php'>Change List Style</p> ";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		echo "<tr id='pp_m3_2_choose' class='pp_m1_1_change' supplierid='$row1[supplierid]' docno='$row1[docno]' style='cursor:pointer;'>";
