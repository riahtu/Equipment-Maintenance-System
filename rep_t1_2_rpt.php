...
echo "<tr><td style='font-weight:bold;'>Report : Requisition by production line</td></tr>";
echo "<tr><td style=''>Date : $now</td></tr>";
echo "</table>";

echo "<table  style='margin-top:20px;font-size:10px;font-family:arial;margin-bottom:30px;text-align:left;border-collapse:collapse;border:1px solid black;' >";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	echo "<td style='width:100px;border-bottom:1px solid #373737;padding-left:3px;font-weight:bold;' >Production Line</td>";
	...
	echo "<td style='width:100px;border-bottom:1px solid #373737;padding-left:3px;font-weight:bold;'>Machine ID</td>";
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		if ($row1[wo_type] != 'PV')$pv_date = '';

		if (!mysql_num_rows($result2) == 0 )
		{
			while($row2 = mysql_fetch_array($result2))
			{
				echo "<td style='width:154px;border-bottom:1px solid #E9E9E9;padding-left:3px;vertical-align:top;padding-top:3px;' >$row2[linecode]</td>";

			}
		}
			
		//echo "<td style='width:154px;border-bottom:1px solid #E9E9E9;padding-left:3px;vertical-align:top;padding-top:3px;' >linecodee</td>";
		echo "<td style='width:154px;border-bottom:1px solid #E9E9E9;padding-left:3px;vertical-align:top;padding-top:3px;' >$row1[wo_type]</td>";
		...
		echo "<td style='width:200px;border-bottom:1px solid #E9E9E9;padding-left:3px;vertical-align:top;padding-top:3px;'>$row1[equipmentid]</td>";
	...
	echo "<td style='width:154px;padding-left:3px;vertical-align:top;padding-top:3px;' ></td>";
		echo "<td style='width:154px;padding-left:3px;vertical-align:top;padding-top:3px;' ></td>";
		echo "<td style='width:200px;padding-left:3px;vertical-align:top;padding-top:3px;'></td>";
