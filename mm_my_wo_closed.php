...
require("db_ems.php");
echo "<table>";
echo "<tr><td style='width:900px;text-align:left;height:30px;'>List of closed Requisitions </td><td> </td></tr>";
echo "</table>";
...
echo "<td  style='width:80px;height:30px;font-weight:bold;border:1px solid #ACACAC;padding-left:3px;'></td>";
...
//		echo "<td style='width:50px;border:1px solid #ACACAC;border-top:0px;border-right:0px;padding-left:3px;'>$row1[closed]</td>";
		...
		echo "<div id='wo_popup_wo' class='icon_part_change' title='Change' workorderid='$row1[workorderid]' data-popup-target='#example-popup'></div>";
		echo "<div id='wo_delete' class='icon_part_delete' title='Delete' workorderid='$row1[workorderid]' data-popup-target='#example-popup'></div>";
		echo "</td>";
