...
require("db_ems.php");
echo "<table>";
echo "<tr><td style='width:1000px;text-align:left;'>List of active work orders </td><td><div id='icon_new_workorder'></div> </td></tr>";
echo "</table>";
...
echo "<td style='width:150px;height:30px;font-weight:bold;border:1px solid #ACACAC;border-right:0px;padding-left:3px;'>Prod. Line</td>";
...
echo "<td style='width:50px;height:30px;font-weight:bold;border:1px solid #ACACAC;padding-left:3px;'>G.Issue</td>";
echo "<td style='text-align:left;width:300px;height:30px;font-weight:bold;border:1px solid #ACACAC;padding-left:3px;'>Problem & Remarks</td>";
...
echo "<td  style='width:150px;height:30px;font-weight:bold;border:1px solid #ACACAC;border-right:0px;padding-left:3px;'><input type='text' placeholder='' id='wo_linecode' style='width:96%;height:100%;background-color:#FFFFE8;border:0px;' /></td>";
...
echo "<td  style='text-align:left;width:50px;height:30px;font-weight:bold;border:1px solid #ACACAC;border-right:0px;padding-left:3px;'></td>";
...
if (!mysql_num_rows($result1) == 0 )
{
	...
	while($row1 = mysql_fetch_array($result1))
    {
		...
		require('db_hra.php');
		$resultp = mysql_query("SELECT * from em_personaldata where employeeno = '$row1[userid]'");
		...
		echo "<tr class='mlist $list_class' workorderid='$row1[workorderid]'>";
		echo "<td  style='width:30px;height:22px;border:1px solid #ACACAC;border-right:0px;border-left:0px;border-top:0px;text-align:center;vertical-align:top;'>$no</td>";
		echo "<td style='width:100px;border:1px solid #ACACAC;border-right:0px;border-top:0px;padding-left:3px;vertical-align:top;'>$row1[workorderid]</td>";
		echo "<td style='width:150px;border:1px solid #ACACAC;border-right:0px;border-top:0px;padding-left:3px;vertical-align:top;' >$linecode</td>";
		echo "<td style='width:200px;border:1px solid #ACACAC;border-right:0px;border-top:0px;padding-left:3px;vertical-align:top;' title='$row1[equipmentid]'>$equipmentdesc</td>";
		echo "<td style='width:110px;border:1px solid #ACACAC;border-right:0px;border-top:0px;padding-left:3px;vertical-align:top;'>$createtime</td>";
		
		echo "<td style='width:100px;border:1px solid #ACACAC;border-top:0px;border-right:0px;padding-left:3px;vertical-align:top;'>$row1[reasoncode]</td>";
		echo "<td style='width:50px;border:1px solid #ACACAC;border-top:0px;border-right:0px;text-align:center;vertical-align:top;'>$giss</td>";
		echo "<td style='text-align:left;width:300px;border:1px solid #ACACAC;border-top:0px;border-right:0px;padding-left:3px;vertical-align:top;'><textarea readonly style='width:290px;height:60px;font-family:arial;font-size:10px;'>$row1[remarks]</textarea></td>";
