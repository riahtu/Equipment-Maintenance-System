...
echo "<div style='text-align:left;margin-top:20px;color:#007CB9;font-weight:bold;'>Generate Purchase Order Return</div>";
...
echo "<tr><td style='width:150px;vertical-align:top;'>Receive Date</td><td id='prv_docdate' style='vertical-align:top;height:30px;'>$docdate</td></tr>";

echo "<tr><td style='width:150px;vertical-align:top;'>Today</td><td id='prv_today' style='vertical-align:top;height:30px;'>$today</td></tr>";
...
if (!mysql_num_rows($result2) == 0 )
{
	while($row2 = mysql_fetch_array($result2))
    {
		...
		echo "<td class='td1' id='prv_description' style='width:325px;text-align:center;'>$row2[sp_description]</td>";
		echo "<td class='td1' id='prv_maker' style='width:200px;text-align:center;'>$maker</td>";
		echo "<td class='td1' id='prv_quantity' style='width:100px;'>$row2[quantity]</td>";
		echo "</tr>";
	}
}
...
echo "<tr><td style='width:100px;'></td><td><button id='pp_m2_2_close' program='pp_m2_2_change.php' style='cursor:pointer;width:200px;height:30px;font-size:10px;'>Return Purchase Order</button></td></tr>";
echo "</table>";
